...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { name_office: @office.name_office, permission: @office.permission, user_id: @office.user_id } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { name_office: @office.name_office, permission: @office.permission, user_id: @office.user_id } }
